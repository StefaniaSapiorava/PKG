...
Dialog::Dialog(dialogType type, QWidget* pwgt) : QDialog(pwgt, Qt::WindowTitleHint|Qt::WindowSystemMenuHint)
{
    ...
    leY1->setText("0");
    leRadius->setText("0");
    leX0->setValidator(new QIntValidator(-500, 500, this));
    leX1->setValidator(new QIntValidator(-500, 500, this));
    leY0->setValidator(new QIntValidator(-500, 500, this));
    leY1->setValidator(new QIntValidator(-500, 500, this));
    leRadius->setValidator(new QIntValidator(0, 500, this));
